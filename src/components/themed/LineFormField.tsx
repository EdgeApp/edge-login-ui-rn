 ...
 * Create a ref object using `useRef<LineFormFieldRef>(null)` or
 * `const ref: { current: LineFormFieldRef | null } = createRef()`
 */
declare class LineFormFieldRef {
  focus: () => void
  blur: () => void
  isFocused: () => boolean
  clear: () => void
...
export const LineFormField = forwardRef(
  (
    props: Props,
    ref: React.ForwardedRef<LineFormFieldRef>
  ): JSX.Element => {
    const {
      // Contents:
      error,
