...
function makeAnimatedFontIcon(
  IconComponent: React.ComponentType<AnimatedProps<VectorIconProps>>,
  name: string
...
function makeFontIcon(
  IconComponent: React.ComponentType<VectorIconProps>,
  name: string
): IconComponent {
...
export const CloseIconAnimated = makeAnimatedFontIcon(
  AnimatedAntDesignIcon,
  'close'
)

export const EyeIcon = makeFontIcon(IonIcon, 'eye-outline')
export const EyeIconAnimated = makeAnimatedFontIcon(
  AnimatedIonIcon,
  'eye-outline'
)

export const EyeOffIcon = makeFontIcon(IonIcon, 'eye-off-outline')
export const EyeOffIconAnimated = makeAnimatedFontIcon(
  AnimatedIonIcon,
  'eye-off-outline'
)

export const SearchIcon = makeFontIcon(AntDesignIcon, 'search1')
export const SearchIconAnimated = makeAnimatedFontIcon(
  AnimatedAntDesignIcon,
  'search1'
)
